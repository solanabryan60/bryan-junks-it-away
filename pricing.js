...
function estimatePickup(d){
 ...
 if(d.itemType==='special'||d.load==='unknown')return {low:null,high:null,note:'We need a closer look to give you a useful estimate. Choose a visit so we can assess the items and access.'};
 ...
 return {low,high,note:difficult?'Extra handling places this pickup toward the upper part of its load-size range. Heavy materials may require an individual quote.':'This range follows your selected load size. Larger loads require an in-person assessment. The online estimate is capped at $900.'};
}
